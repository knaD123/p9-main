...
python3 create_confs.py --threshold 100 --random_seed 2 --topology ${TOPO} --conf confs/12-22_existing_algorithms_threshold_100_2 --result_folder results/12-22_existing_algorithms_threshold_100_2 --demand_file ${DEMAND} --algorithm rsvp_fn
