...
python3 create_confs.py --topology ${TOPO} --conf confs/12-22_existing_algorithms --result_folder results/12-22_existing_algorithms --demand_file ${DEMAND} --algorithm rsvp_fn
